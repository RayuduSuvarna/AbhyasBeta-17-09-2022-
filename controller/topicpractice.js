   ...
   if(JSON.parse(localStorage.getItem('examresultjson'))){ 
    ...
    $scope.showresults='';
       ...
       // return false;
        ...
        $scope.startPracticeExam();

    }

    $scope.startPracticeExam=function(x){
        ...
        if (arg == 'test') {
         ...
         //   console.log(Sendobj);
            ...
            $scope.videoPlayMongo = {
                ...
                "eventCategory": 'PracticeExam',
                "eventDetails": Sendobj,     
                "title1": $scope.studentpaper.Questions[0].subject_master_name,
                "title2": $scope.topic_array.Topicname,
                "duration": $scope.fpaper[ind].time_spent,
                "result" : ((totalcorrect.length) * 1 / ($scope.inserteddata.Questions.length)) * 100
    ...
    $scope.showqr = function (suc, uuserid) {
        ...
        $http.get(apiurl+'/practicetest/' + suc + '/' + uuserid).success(function (data) {
           // console.log(data);
            ...
            // $scope.FinalResult.topic_master_name = 'test';
            // $scope.FinalResult.subject_name = 'test2';
            // $scope.FinalResult.attempted = 'test3';
            // $scope.FinalResult.topic_master_name = 'test4';
...
//show all results end 
    ...
    $scope.show_practicevideos=function(topics){
        ...
        var singlesubjectdata = data.filter(e => e.topicName == topics);
           
       //  console.log(singlesubjectdata)
